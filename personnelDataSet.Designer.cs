...
namespace WebProject2.personnelDataSetTableAdapters {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Employee] SET [name] = @name, [position] = @position, [hourly_pay_r" +
                "ate] = @hourly_pay_rate WHERE (([employeeID] = @Original_employeeID))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["PersonnelConnectionString"].ConnectionString;
        }
        ...
        public virtual int Update(string name, string position, decimal hourly_pay_rate, int Original_employeeID) {
            if ((name == null)) {
                throw new global::System.ArgumentNullException("name");
            }
            else {
